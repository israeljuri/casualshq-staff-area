import { Table, TableHead, TableHeader, TableRow } from '@/components/molecules/Table';
  ...
  return (
    <Table className="relative min-h-[40rem]">
      <TableHeader className="border border-olive-100 bg-olive">
        <TableRow className="grid grid-cols-5 bg-gray-50 hover:bg-gray-100">
      ...
      <div className="absolute top-[40%] left-[50%] translate-x-[-50%] flex flex-col items-center justify-center col-span-full">
